...
do
    ...
    python examples/baselines/sac_nano_gpt/D_ver4.py --env_id="OpenCabinetDrawer-v1" --no-track \
        --total_timesteps=3_000_000  --num_envs=32 --num_eval_envs=16 --eval_freq=10_000 \
