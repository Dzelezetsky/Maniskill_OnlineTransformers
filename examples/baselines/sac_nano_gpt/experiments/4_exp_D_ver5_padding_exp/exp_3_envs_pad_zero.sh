...
do
    ...
    python ../../D_ver5_pad_zero.py --env_id="PickCube-v1" --no-track \
    ...
    python ../../D_ver5_pad_zero.py --env_id="TriFingerRotateCubeLevel0-v1" --no-track \
    ...
    python ../../D_ver5_pad_zero.py --env_id="PushT-v1" --no-track \
