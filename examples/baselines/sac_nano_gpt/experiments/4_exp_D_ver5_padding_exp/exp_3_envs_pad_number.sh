...
do
    ...
    python ../../D_ver5_pad_number.py --env_id="PickCube-v1" --no-track \
    ...
    python ../../D_ver5_pad_number.py --env_id="TriFingerRotateCubeLevel0-v1" --no-track \
        --total_timesteps=2_000_000  --num_envs=32 --num_eval_envs=100 --eval_freq=10_000 \
    ...
    python ../../D_ver5_pad_number.py --env_id="PushT-v1" --no-track \
        --total_timesteps=5_000_000  --num_envs=32 --num_eval_envs=100 --eval_freq=10_000 \
        --no-partial_reset --no-eval_partial_reset --control_mode="pd_ee_delta_pos" \
        --utd=0.5 --buffer_size=1_000_000 --num-steps=100 --num_eval_steps=100 \
        --seq_len 10 --n_layer 1 --n_head 2 --n_embd 256 --dropout 0.0 --bias \
        --seed $seed
