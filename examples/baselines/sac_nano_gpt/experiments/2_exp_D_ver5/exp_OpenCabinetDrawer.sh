...
do
    ...
    python examples/baselines/sac_nano_gpt/D_ver5.py --env_id="OpenCabinetDrawer-v1" --no-track \
        --total_timesteps=3_000_000  --num_envs=32 --num_eval_envs=100 --eval_freq=10_000 \
        --no-partial_reset --no-eval_partial_reset --control_mode="pd_ee_delta_pos" \
        --utd=0.5 --buffer_size=1_000_000 \
