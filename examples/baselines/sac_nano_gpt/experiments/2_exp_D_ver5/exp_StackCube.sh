...
do
    ...
    python examples/baselines/sac_nano_gpt/D_ver5.py --env_id="StackCube-v1" --no-track \
        --total_timesteps=20_000_000  --num_envs=32 --num_eval_envs=100 --eval_freq=10_000 \
