...
do
    ...
    CUDA_VISIBLE_DEVICES=$CUDA_DEV python examples/baselines/sac_nano_gpt/D_ver5_RGBD_NEW_last_pad.py --env_id="PullCube-v1" --obs_mode="rgb" --camera_width=64 --camera_height=64 \
        --total_timesteps=300_000 --buffer_size=900_000 --num_envs=384 --num_eval_envs=384 --training_freq=768 \
