...
do
    ...
    CUDA_VISIBLE_DEVICES=$CUDA_DEV python examples/baselines/sac_nano_gpt/D_ver5_RGBD_NEW_last_pad.py --env_id="PickCube-v1" --obs_mode="rgb" --camera_width=64 --camera_height=64 \
