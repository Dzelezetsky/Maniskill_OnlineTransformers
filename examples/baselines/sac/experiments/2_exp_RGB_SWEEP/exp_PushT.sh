...
do
    ...
    python examples/baselines/sac/sac_rgbd.py --env_id="PushT-v1" --obs_mode="rgb" --camera_width=64 --camera_height=64 \
        --total_timesteps=2_000_000 --buffer_size=300_000 --num_envs=32 --num_eval_envs=32 \
