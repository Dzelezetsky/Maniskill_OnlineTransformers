...
do
    ...
    CUDA_VISIBLE_DEVICES=$CUDA_DEV python examples/baselines/sac/sac_rgbd.py --env_id="PokeCube-v1" --obs_mode="rgb" --camera_width=64 --camera_height=64 \
        --total_timesteps=5_000_000 --buffer_size=850_000 --num_envs=385 --num_eval_envs=385 --training_freq=770 \
