...
bash examples/baselines/sac_nano_gpt/experiments/1_exp_D_ver4/exp_RollBall.sh #examples/baselines/sac_nano_gpt/experiments/1_exp_D_ver4/exp_StackCube.sh #examples/baselines/sac_nano_gpt/experiments/2_exp_D_ver5/exp_StackCube.sh #examples/baselines/sac_nano_gpt/experiments/2_exp_D_ver5/exp_PokeCube.sh #examples/baselines/sac_nano_gpt/experiments/1_exp_D_ver4/exp_PickCube.sh #examples/baselines/sac_nano_gpt/experiments/1_exp_D_ver4/exp_PushT.sh